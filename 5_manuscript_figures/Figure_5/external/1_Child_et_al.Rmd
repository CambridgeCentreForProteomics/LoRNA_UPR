...
```{r}
proportions_per_rep <- readRDS('../../../3_rna/notebooks/1_dlorna/2_lorna/3_proportional_localisation/results/proportions_per_rep.rds')
...
p <- proportions_per_rep$gene %>%
  ...
  stat_summary(geom='bar', position=position_dodge(width=0.7), width=0.7) +
  geom_quasirandom(dodge.width=0.7, width=0.2, show.legend=FALSE) +
  stat_summary(geom='errorbar', position=position_dodge(width=0.7), width=0.3) +
