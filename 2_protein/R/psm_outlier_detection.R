...
# Identify PSMs which are outliers according to the distance between their profile over the TMT tags and the median profile for all other PSMs from the same protein
